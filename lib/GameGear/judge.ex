alias SFML.Graphics.{Sprite, CircleShape}
...
defmodule GameGear.Judge do
  ...
  """
  def overrun?(%{body: s, velocity: [vx, vy]}, [xmin, ymin, xmax, ymax]) do
    with(
  ...
  def overrun2?(%{body: s, velocity: [vx, vy]}, [xmin, ymin, xmax, ymax]) do
    with(
      [x, y, w, h] = CircleShape.get_global_bounds(s),
      x = x - xmin, xmax = xmax - w,
      y = y - ymin, ymax = ymax - h,
    do:
      [
